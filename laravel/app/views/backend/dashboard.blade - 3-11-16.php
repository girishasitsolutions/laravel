...
@section('content')
	...
	<section class="wrapper site-min-height">
		<div class="row">
			...
			$last_day  = strtotime(date('t-m-Y', strtotime('-1 months')));
					...
					<a href ="{{ URL::to('admin/users/import_data_list/all/ass/1')}}">
						<div class="col-lg-3 col-sm-6">
							<section class="panel">
								...
								<div class="value">
									<h1 class="count">{{ GeneralHelper::getAllBarChartData('Ass',  Auth::id(), Auth::User()->role_id, 1)}}</h1>
					...
					<a href ="{{ URL::to('admin/users/import_data_list/all/pro/1')}}">
						<div class="col-lg-3 col-sm-6">
							<section class="panel">
								...
								<div class="value">
									<h1 class="count">{{ GeneralHelper::getAllBarChartData('pro',  Auth::id(), Auth::User()->role_id, 1)}}</h1>
					...
					<a href ="{{ URL::to('admin/users/import_data_list/all/pa/1')}}">
						<div class="col-lg-3 col-sm-6">
							<section class="panel">
								...
								<div class="value">
									<h1 class="count">{{ GeneralHelper::getAllBarChartData('pa',  Auth::id(), Auth::User()->role_id, 1)}}</h1>
