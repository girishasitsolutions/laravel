	...
	<section class="wrapper site-min-height">
		<div class="row">
		 ...
		 <div class="row state-overview">
			<a href ="{{ URL::to('admin/users/import_data_list/all/ass')}}">
				<div class="col-lg-3 col-sm-6">
					<section class="panel">
						...
						<div class="value">
							<h1 class="count">{{ GeneralHelper::getAllBarChartData('Ass',  Auth::id(), Auth::User()->role_id)}}</h1>
							<p><strong>Assistance Account</strong></p>
						</div>
					</section>
				</div>
			</a>
			<a href ="{{ URL::to('admin/users/import_data_list/all/pro')}}">
				<div class="col-lg-3 col-sm-6">
					<section class="panel">
						...
						<div class="value">
							<h1 class="count">{{ GeneralHelper::getAllBarChartData('pro',  Auth::id(), Auth::User()->role_id);}}</h1>
							<p><strong>Processing Account</strong></p>
						</div>
					</section>
				</div>
			</a>
			<a href ="{{ URL::to('admin/users/import_data_list/all/pa')}}">
				<div class="col-lg-3 col-sm-6">
					<section class="panel">
						...
						<div class="value">
							<h1 class="count">{{ GeneralHelper::getAllBarChartData('pa',  Auth::id(), Auth::User()->role_id)}}</h1>
		...
		<div class="row state-overview"> <?php
			...
			$first_day = strtotime(date('d-m-Y', strtotime('-1 months'))); // hard-coded '01' for first day
